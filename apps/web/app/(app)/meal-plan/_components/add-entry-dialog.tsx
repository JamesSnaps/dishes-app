...
export function AddEntryDialog({ weekStartDate, dayOfWeek, dayLabel, recipes, trigger }: Props) {
  ...
  // Derive unique filter options from recipe list
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-h-[92vh] flex flex-col gap-0 p-0 sm:max-w-xl overflow-hidden">
        {/* Header */}
        <DialogHeader className="px-5 pt-5 pb-3 border-b shrink-0">
          <DialogTitle className="text-base">Add meal — {dayLabel}</DialogTitle>
        </DialogHeader>

        {/* Meal type + search + filter controls */}
        <div className="px-4 pt-3 pb-2 space-y-3 shrink-0 border-b">
          {/* Meal type */}
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 h-9 rounded-md border text-sm font-medium transition-all ${
          ...
          {filtersOpen && (
            <div className="space-y-3 pt-1 pb-0.5">
              ...
              {/* Difficulty + Rating + Favourites row */}
                    ...
                    <div className="flex-1 px-2.5 py-2 flex flex-col gap-1">
                      ...
                      <div className="flex flex-wrap items-center gap-1.5 mt-auto">
                        {recipe.avgRating !== null && (
                          <StarRow rating={recipe.avgRating} size="xs" />
                        )}
                        {recipe.cuisine && (
